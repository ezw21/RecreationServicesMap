import {AllWidgetProps, React, WidgetInjectedProps, RawWidgetType, IMState, WidgetProps, MutableStoreManager, injectIntl, withTheme, ReactRedux} from 'jimu-core';
...
export function wrapWidget(WidgetClass: RawWidgetType, props?: WrappedWidgetProps): WrappedWidgetTypePartialProps{
  ...
  const ThemedWidgetWrapper = withTheme(IntlInjectedComponent) as WrappedWidgetTypePartialProps
