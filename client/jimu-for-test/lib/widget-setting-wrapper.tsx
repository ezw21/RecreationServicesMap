import {React, IMState, injectIntl, withTheme, ReactRedux} from 'jimu-core';
...
export function wrapWidgetSetting(WidgetSettingClass: RawWidgetSettingType, props?: WrappedWidgetSettingProps): WrappedWidgetSettingTypePartialProps{
  ...
  const ThemedWidgetSettingWrapper = withTheme(IntlInjectedComponent) as WrappedWidgetSettingTypePartialProps
