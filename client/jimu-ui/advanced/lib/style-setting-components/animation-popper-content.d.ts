...
declare const _default: ReactRedux.ConnectedComponent<typeof AnimationPopperContent, ReactRedux.Omit<React.ClassAttributes<AnimationPopperContent> & OwnProps & StateToProps, "selectedWidgetLabel"> & OwnProps>;
