...
export declare const _IconViewer: ReactRedux.ConnectedComponent<typeof __IconViewer, ReactRedux.Omit<React.ClassAttributes<__IconViewer> & IconViewerProps & ExtraProps, "theme" | "intl" | "appInBuilderTheme"> & IconViewerProps>;
export declare const IconViewer: React.ComponentType<Omit<IconViewerProps, "intl"> & {
