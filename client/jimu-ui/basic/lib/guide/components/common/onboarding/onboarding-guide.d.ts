...
export declare const OnboardingGuide: ReactRedux.ConnectedComponent<typeof _OnboardingGuide, ReactRedux.Omit<React.ClassAttributes<_OnboardingGuide> & GuideProps & StateToProps, "queryObject" | "pageMode"> & GuideProps>;
export {};
