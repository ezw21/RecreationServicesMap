...
export declare const _VIPillSelector: ReactRedux.ConnectedComponent<typeof _VIPillSelectorInner, ReactRedux.Omit<React.ClassAttributes<_VIPillSelectorInner> & Props & DatasourceProps & IntlProps, "datasourceInfo" | "datasourceBelongInfo"> & Props>;
declare const VIPillSelector: React.ComponentType<Omit<Props & IntlProps, "intl"> & {
