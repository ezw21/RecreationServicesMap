...
export declare class MapDataSourceImpl extends AbstractSetDataSource implements MapDataSource {
     ...
     */
    protected getDataSourceConstructorOptions(id: string, url: string, dsJsonInConfig: IMDataSourceJson, layer?: __esri.Layer): Promise<Array<LayerFolderDataSourceConstructorOptions | FeatureLayerDataSourceConstructorOptions | SceneLayerDataSourceConstructorOptions>>;
}
