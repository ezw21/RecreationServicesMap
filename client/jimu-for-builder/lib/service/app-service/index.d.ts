...
import { ISearchOptions, ISharingResponse, IMoveItemOptions, IMoveItemResponse, IGetUserTagsResponse, IGroup, SearchQueryBuilder, ISearchResult, IItemResourceOptions, IItemResourceResponse } from '@esri/arcgis-rest-portal';
 ...
 *folderId: If the folderId has a value, the app will be created in the folder corresponding to the folderId
 */
export declare function createAppByDefaultTemplate(title: string, lable: string, folderId?: string): Promise<AppInfo>;
/**
 ...
 * folderId: If the folderId has a value, the app will be created in the folder corresponding to the folderId
*/
export declare function duplicateApp(appInfo: AppInfo, folderId?: string): Promise<boolean>;
