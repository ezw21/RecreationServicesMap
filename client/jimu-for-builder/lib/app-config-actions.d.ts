...
export declare class AppConfigAction {
     ...
     * @newAppConfig
     * */
    private clearDeletedWidgetMessageAction;
    /**
     * Get the message config of the deleted widget
     * @oldAppConfig
     * @newAppConfig
     * */
    private getDeletedWidgetsMessageConfigs;
    /**
     * Remove message action
     * @message
     * */
    private removeMessageAction;
    /**
     ...
     *
     * When start to duplicate a page or dialog, must clean this map and set it as `{}`, and set this to null when duplication is done.
     * When duplicate an item, if this property is not null, will use and update  this property
     */
