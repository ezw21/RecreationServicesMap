define({
  ...
  minutes: 'นาที',
  allowExport: 'อนุญาตการส่งออก',
  exportNotice: 'สำหรับชั้นข้อมูลฟีเจอร์ที่โฮสต์ แอปจะตรวจสอบเพื่อยืนยันว่าบทบาทของผู้ใช้ และการตั้งค่าไอเท็มนั้นอนุญาตให้ส่งออกข้อมูล'
});