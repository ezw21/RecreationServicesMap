define({
  ...
  minutes: 'minúty',
  allowExport: 'Povoliť export',
  exportNotice: 'V prípade hostovaných prvkových vrstiev aplikácia overí, či nastavenia role a položky koncového používateľa umožňujú export údajov.'
});