define({
  ...
  minutes: 'phút',
  allowExport: 'Cho phép xuất',
  exportNotice: 'Đối với các lớp đối tượng được lưu trữ, ứng dụng cũng sẽ xác minh vai trò của người dùng cuối và các thiết lập của mục mà cho phép xuất dữ liệu.'
});