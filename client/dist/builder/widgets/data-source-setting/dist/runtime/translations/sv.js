define({
  ...
  minutes: 'minuter',
  allowExport: 'Tillåt export',
  exportNotice: 'För driftade geoobjektlager verifierar appen även att slutanvändarens roll och objektinställningar tillåter export av data.'
});