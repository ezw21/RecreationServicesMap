...
describe('GDB VMS Manager', async function() {
  /*
  ...
  */
  /*
  it('can get versions by url', async function() {
...
describe('Create Version', async function() {
...
describe('Switch between services', async function() {
  /*
...
describe('Search versions', async function() {
...
describe('Switch versions', async function() {
  /*
...
describe('View verion information', async function() {
...
describe('Create a new version', async function() {
  /*
...
describe('Manage existing versions', async function() {
  /*
...
describe('Delete a version', async function() {
  /*
...
/*
describe('Create and update version name', async function() {
...
describe('Create Version Name', async function() {
  /*
  const vms = new _VMSManager();
  it('Name exceeded 62 character check - local', function() {
...
describe('Create and update version descriptions', async function() {
...
describe('User access privileges to versions', async function() {
  /*
...
describe('Define and update version access privileges', async function() {
...
describe('Define and update version owner', async function() {
...
describe('Activate this version upon creation or update', async function() {
  /*
...
describe('Save or cancel new versions or changes to existing versions', async function() {
  /*
...
describe('Basic and Advanced arrangement styles', async function() {
  /*
...
describe('Seach and select versions in the service', async function() {
...
describe('Enable and disable version management capabilities', async function() {
...
describe('Version information fields order', async function() {
