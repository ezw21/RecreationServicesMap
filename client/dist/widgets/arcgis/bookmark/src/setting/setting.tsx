...
import {
  ...
  Collapse, NumericInput, ButtonGroup, Select, Slider, ImageFillMode, Tabs, Tab, Tooltip, Switch, ConfirmDialog
} from 'jimu-ui'
                  ...
                  return (
                    <Fragment key={index}>
                      <div className={`${activeId === item.id ? 'active-mark' : ''} setting-bookmark-list`} onClick={() => this.handleSelect(item.id as number, item)}>
                        <TextInput
                          className='header-title-input h5 bookmark-edit-input' ref={titleTextInput} size='sm'
                    ...
                    directions.map((data, i) => {
                      return (
                        <Button
                          ...
                          onClick={this.handleDirectionClick}
                        >
                          <Icon size={12} icon={data.icon} autoFlip />
                        </Button>
                      )
                    })
                  }
