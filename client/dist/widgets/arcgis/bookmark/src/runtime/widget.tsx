...
> {
  ...
  componentDidUpdate (prevProps) {
    ...
    const { config, appMode, id, autoplayActiveId } = this.props
  ...
  renderBottomTools = (example?: boolean) => {
    ...
    const dropdownBtn = (
      <Icon
        icon={require('jimu-ui/lib/icons/text-dots.svg')}
        size={14}
        style={{ marginRight: 3 }}
      />
    )
                ...
                >
                  <div className='bookmark-btn-container'>
                    {config.autoPlayAllow && (
                      ...
                      >
                        <Icon
                          icon={autoPlayStart ? IconStop : IconPlay}
                          className='mr-1'
                          size={16}
                        />
                      </Button>
            ...
            bookmarks.length > 1 ? (
              <div className='suspension-tools-text align-items-center justify-content-around'>
                <Select
                  ...
                  buttonProps={{
                    arrow: dropdownBtn,
                    className: 'suspension-noborder-btn',
                    type: 'default'
                  }}
                  title={this.formatMessage('bookmarkList')}
                >
    ...
    return (
      ...
      >
        ...
        >
          <Icon
            autoFlip
            icon={isHorizon ? arrowLeft12 : arrowUp12}
            size={12}
          />
        </Button>
        <Button
        ...
        >
          <Icon
            autoFlip
            icon={isHorizon ? arrowRight12 : arrowDown12}
            size={12}
          />
        </Button>
      </div>
                  ...
                  >
                    ...
                    <CardBody className='widget-card-content text-truncate runtime-title-con'>
                      <TextInput
                        ...
                        onChange={evt =>
                          this.onRuntimeBookmarkNameChange(
                            rbmId,
                            evt.target.value
                          )}
                        onKeyDown={evt =>
                          this.handleKeydown(evt, titleTextInput)}
                      />
                    </CardBody>
                  </Card>
            ...
            return (
              ...
              >
                ...
                <TextInput
                  ...
                  // onClick={evt =>  evt.stopPropagation()}
                  onChange={evt =>
                    this.onRuntimeBookmarkNameChange(rbmId, evt.target.value)}
