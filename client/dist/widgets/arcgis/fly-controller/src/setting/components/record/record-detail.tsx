...
import { Button, TextInput, NumericInput, Slider, Radio, Icon, Label, defaultMessages } from 'jimu-ui'
    ...
    return (isDefined(recordConfig) &&
      <div className='w-100' css={this.getStyle()}>
        ...
        <SettingSection>
          ...
          <Icon icon={require('jimu-ui/lib/icons/tool-delete.svg')} size={12} />
        </Button> */}
          ...
          <SettingRow>
            <TextInput
              ...
              title={recordConfig.displayName} value={recordConfig.displayName ?? ''}
              onChange={evt => this.handleDisplayNameChange(evt.target.value)}
  ...
  renderPointsAdvancedSettings = (): React.ReactElement => {
    ...
    return (
      <React.Fragment>
        ...
        <SettingRow>
          <NumericInput
            className='w-100' showHandlers={false}
