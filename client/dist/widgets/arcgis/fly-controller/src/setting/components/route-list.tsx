...
import { Button, Icon, defaultMessages as jimuUiNls } from 'jimu-ui'
...
export class RouteList extends React.PureComponent<Props, States> {
  ...
  render (): React.ReactElement {
    ...
    return (
      <div className='item-detail-wapper'>
        {/* level-1 */}
        <SettingRow>
          <Button
          ...
          >
            <Icon className='d-flex' icon={require('jimu-ui/lib/icons/add-24.svg')} size={12} />{newRouteLabel}
          </Button>
        </SettingRow>
      ...
      return {
        ...
        itemStateCommands: [
          { // [0]
            ...
            collapsed: !isVisible,
            iconProps: () => ({ icon: require('jimu-ui/lib/icons/visible.svg') }),
            action: (data) => {
            ...
            collapsed: isVisible,
            iconProps: () => ({ icon: require('jimu-ui/lib/icons/invisible.svg') }),
            action: (data) => {
