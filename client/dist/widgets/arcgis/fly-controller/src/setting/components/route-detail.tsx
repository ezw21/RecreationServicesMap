...
import { Button, TextInput, Icon, Dropdown, DropdownButton, DropdownMenu, DropdownItem, Label, Badge, defaultMessages as jimuUiNls } from 'jimu-ui'
...
const rotateIcon = require('../../assets/icons/mark-point.svg')
const pathIcon = require('../../assets/icons/trigger-draw-line.svg')
// const pickIcon = require('../../assets/icons/trigger-pick.svg');
const warningOf3D = require('jimu-ui/lib/icons/warning-12.svg')
        ...
        <div className='w-100 h-100'>
          ...
          <SettingSection>
            <Button className='page-back-btn' type='tertiary' onClick={this.handleBackBtnClick}>
              <Icon icon={require('jimu-ui/lib/icons/direction-left.svg')} size={16} autoFlip />
            ...
            <SettingRow>
              <TextInput
                ...
                onChange={evt => this.handleRouteNameChange(evt.target.value)}
    ...
    if (this.props.isPreviewRouteBtnPlaying) {
      content = (
        <Button icon onClick={this.handlePreviewRoute} title={pauseLabel} disabled={isDisable}>
          <Icon icon={require('../../assets/icons/pause.svg')} size={12} />
        </Button>
      )
    } else {
      ...
      content = (
        <Button icon onClick={this.handlePreviewRoute} title={title} disabled={isDisable}>
          <Icon icon={require('../../assets/icons/play.svg')} size={12} />
        </Button>
      )
    }
