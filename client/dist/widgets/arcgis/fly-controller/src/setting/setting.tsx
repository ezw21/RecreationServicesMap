/** @jsx jsx */
import { React, jsx, Immutable, IMState, IMAppConfig, LayoutInfo, LayoutType, IMThemeVariables, getAppStore, appActions } from 'jimu-core'
...
export default class Setting extends React.PureComponent<AllWidgetSettingProps<IMConfig> & ExtraProps & CustomeProps, State> {
                  ...
                  if (FlyItemMode.Rotate === style) {
                    ...
                    return (
                      <div key={idx}>
                        ...
                        {/* 1.RoutesList */}
                        {this.renderRoutesList(styleConfig as RouteItemConfig, idx, styleConfig.isInUse)}
                      </div>
                    )
                  }
                })}
  ...
  handleRoutesOrderUpdate = (treeItems: TreeItemsType): void => {
    ...
    const reorderdItems = []
    treeItems.map((item: TreeItemType/*, keyIdx */) => {
  ...
  renderRoutesList = (routeConfig: RouteItemConfig, idx: number, isInUse: boolean): React.ReactElement => {
