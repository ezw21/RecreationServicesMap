...
export default abstract class BaseFlyController {
  ...
  async setup (param: InitParams): Promise<BaseFlyController> {
    await loadArcGISJSAPIModules([
      ...
      [
        this.libVec3f64, this.libMat4f64, this.libVec3, this.libMat4, this.libQuatf64, this.libQuat, this.cameraUtils,
        this.GLCamera, this.Point, this.esriMathUtils, this.watchUtils, this.Camera
      ] = modules
