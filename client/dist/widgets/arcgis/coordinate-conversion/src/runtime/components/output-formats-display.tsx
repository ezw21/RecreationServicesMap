...
export default class OutputFormatsDisplay extends React.PureComponent<Props, IState>{
  ...
  private outputLabel = React.createRef<HTMLDivElement>();
  private _copyOutputTextbox = React.createRef<HTMLInputElement>();
  private _copyDetailsTextbox = React.createRef<HTMLInputElement>();
  private editTextFocus = React.createRef<HTMLInputElement>();
  private details1Input = React.createRef<HTMLInputElement>();
  private details2Input = React.createRef<HTMLInputElement>();
  private details3Input = React.createRef<HTMLInputElement>();
  private details4Input = React.createRef<HTMLInputElement>();
  details1Value: string;
  details2Value: string;
  details3Value: string;
  details4Value: string;
  constructor(props) {
    ...
    this.state = {
      ...
      isOutputFormatExpanded: this.props.isOpen ? true : false,
  ...
  onOutputSettingsClick = () => {
    this.setState({
      ...
      currentOutputFormatLabel: this.state.outputFormatLabel
    }, () => {
        ...
        <SettingRow flow={'wrap'}>
          <div className={'d-flex justify-content-between w-100 align-items-center'}>
            <Label id={'outputFormatLabel' + this.props.parentWidgetId + this.props.index}
              className={this.props.conversionInfo.format.name === 'address' ? 'w-100 outputSettingsFormatLabel outputSettingsAddressLabel' : 'w-100 outputSettingsFormatLabel'}>
          ...
          <table cellPadding={10}>
            <tbody>
              <tr>
                ...
                <td>
                  <TextInput required role={'textbox'} ref={this.editTextFocus} aria-label={this.nls('editLabel')} value={this.state.outputFormatLabel}
                    onAcceptValue={this.onFormatLabelChange} className={this.state.currentOutputFormatLabel === '' ? 'format-label invalid-value' : 'format-label'} />
                </td>
              </tr>
              <tr className={this.props.conversionInfo.format.name === 'address' ? 'hidden' : ''}>
                ...
                <td>
                  <TextInput required role={'textbox'} aria-label={this.nls('editFormat')} value={this.state.outputFormatPattern} onAcceptValue={this.onFormatChange}
        ...
        { /* First two rows of details are present in all the formats */
          <Collapse isOpen={this.state.isOutputFormatExpanded}>
            <div className={'pt-2'}>
              ...
              <SettingRow flow={'wrap'}>
                <div className={'d-flex justify-content-between w-100 align-items-center'}>
                  <Label id={'details1Label' + this.props.parentWidgetId + this.props.index} className={'details-section-label'}>{this.state.details1Label}</Label>
                  <TextInput role={'textbox'} aria-labelledby={'details1Label' + this.props.parentWidgetId + this.props.index} size={'sm'}
                    ref={this.details1Input} value={this.formatDisplayCoordinate(this.state.details1Value)} readOnly={true} />
              ...
              <SettingRow flow={'wrap'} >
                <div className={'d-flex justify-content-between w-100 align-items-center'}>
                  <Label id={'details2Label' + this.props.parentWidgetId + this.props.index} className={'details-section-label'}>{this.state.details2Label}</Label>
                  <TextInput role={'textbox'} aria-labelledby={'details2Label' + this.props.parentWidgetId + this.props.index} size={'sm'}
                    ref={this.details2Input} value={this.formatDisplayCoordinate(this.state.details2Value)} readOnly={true} />
              ...
              {this.state.details3Visible &&
                <SettingRow flow={'wrap'}>
                  <div className={'d-flex justify-content-between w-100 align-items-center'}>
                    <Label id={'details3Label' + this.props.parentWidgetId + this.props.index} className={'details-section-label'}>{this.state.details3Label}</Label>
                    <TextInput role={'textbox'} aria-labelledby={'details3Label' + this.props.parentWidgetId + this.props.index} size={'sm'}
                      ref={this.details3Input} value={this.state.details3Value} readOnly={true} />
              ...
              {this.state.details3Visible &&
                <SettingRow flow={'wrap'} >
                  <div className={'d-flex justify-content-between w-100 align-items-center'}>
                    <Label id={'details4Label' + this.props.parentWidgetId + this.props.index} className={'details-section-label'}>{this.state.details4Label}</Label>
                    <TextInput role={'textbox'} aria-labelledby={'details4Label' + this.props.parentWidgetId + this.props.index} size={'sm'}
                      ref={this.details4Input} value={this.state.details4Value} readOnly={true} />
