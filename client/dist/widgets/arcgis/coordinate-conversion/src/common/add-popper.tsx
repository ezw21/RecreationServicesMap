...
export class AddPopper extends React.PureComponent<Props, IState> {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <table cellPadding={10}>
          <tbody>
            <tr>
              ...
              <td>
                <Select aria-label={this.nls('defaultCoordinate')} name={'defaultCoords'}
                  value={this.state.addDefaultCoordinate}
            ...
            <tr>
              ...
              <td>
                <TextInput role={'textbox'} aria-label={this.nls('coordinateLabel')}
                  className={this.state.coordinateLabel === '' ? 'invalid-value' : ''}
                  value={this.state.coordinateLabel} onAcceptValue={this.onFormatLabelChange} />
              </td>
            </tr>
            <tr className={this.state.addDefaultCoordinate === 'address' ? 'hidden' : ''}>
              ...
              <td>
                <TextInput role={'textbox'} aria-label={this.nls('coordinateFormat')}
                  ...
                  value={this.state.currentPattern} onAcceptValue={this.onFormatChange} />
              </td>
              <td>
