...
import { React, jsx, IntlShape, ThemeVariables, defaultMessages as jimuCoreDefaultMessages } from 'jimu-core';
...
export default class OutputSetting extends React.PureComponent<Props, State>{
  ...
  render() {
    return <div css={getOutputSettingsStyle(this.props.theme)} style={{ height: '100%', width: '100%', marginTop: '5px' }}>
      ...
      {
        <SidePopper isOpen={this.state.showOutputSettingsPopper} position={'right'} toggle={this.closeOutputSettingPopper.bind(this)}
