  ...
  render() {
    return <div style={{ height: '100%', marginTop: '5px' }}>
      <div css={getInputSettingsStyle(this.props.theme)}>
        ...
        <SettingRow label={this.nls('format')} flow={'wrap'}
          className={this.state.defaultCoords === 'address' ? 'hidden' : ''}>
          <div className={'d-flex justify-content-between w-100 align-items-center'}>
            <TextInput role={'textbox'} aria-label={this.nls('format')} className={'formatLabel'} value={this.state.defFormat} onChange={this.onFormatChange} />
