...
class _Setting extends React.PureComponent<
  AllWidgetSettingProps<IMConfig> & CustomeProps & ExtraProps,
  State
> {
...
export default ReactRedux.connect<ExtraProps, unknown, CustomeProps>(
  mapStateToProps
)(_Setting)
