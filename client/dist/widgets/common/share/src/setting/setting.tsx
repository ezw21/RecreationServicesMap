...
export default class Setting extends React.PureComponent<AllWidgetSettingProps<IMConfig> & ExtraProps> {
  ...
  // 1
  private readonly onUIModeChanged = (e) => {
    ...
    subSettingUI = (
      <div>
        <SettingSection>
          <SettingRow>
            <div className='d-flex justify-content-between align-items-center w-100 align-items-start'>
              ...
              <IconPicker
                configurableOption='all' buttonOptions={{ type: 'default', size: 'sm' }} hideRemove icon={icon as any} groups='none'
        ...
        <SettingSection title={shareOption}>
          <ItemsSelector
            items={items} theme={theme} intl={intl}
          ...
          <SettingRow>
            <div className='ui-mode-card-chooser'>
              <div className='ui-mode-card-wapper'>
                <img
                  className={classNames('ui-mode-card', {
                    'active': (this.props.config.uiMode === UiMode.Popup),
                    'card-flip': isRTL
                  })} data-uimode={UiMode.Popup} id='uimode-0' src={require('./assets/style0.svg')} onClick={this.onUIModeChanged}
                />
              ...
              <div className='ui-mode-card-wapper'>
                <img
                  className={classNames('ui-mode-card', {
                    'active': (this.props.config.uiMode === UiMode.Inline),
                    'card-flip': isRTL
                  })} data-uimode={UiMode.Inline} id='uimode-1' src={require('./assets/style1.svg')} onClick={this.onUIModeChanged}
                />
