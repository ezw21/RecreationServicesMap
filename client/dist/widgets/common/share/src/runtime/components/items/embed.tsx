...
import { Button, defaultMessages as jimuUIDefaultMessages, Label, TextInput, TextArea, Select } from 'jimu-ui'
    ...
    if (shownMode !== ShownMode.Btn) {
      content = (
        <div css={this.getStyle()}>
          <BackBtn uiMode={this.props.uiMode} onBackBtnClick={this.onBackBtnClick} />

          <TextArea name='text' id='embedlinkText' className='share-url-input' value={this.state.text} />
          ...
          <div>
            ...
            <div className='d-flex align-items-center embed-options-wapper'>
              ...
              <div className='d-flex align-items-center'>
                <TextInput value={this.state.w} className='flex-fill embed-option' onChange={this.onWChange} />
                X
                <TextInput value={this.state.h} className='flex-fill embed-option' onChange={this.onHChange} />
              </div>
            </div>
          </div>
        </div>
