...
export class ItemBtn extends React.PureComponent<Props> {
  ...
  getBtnStyles () {
    ...
    const btnShadow = ''; const // this.getBtnShadow(),
  ...
  render () {
    ...
    const labelOutOfBtnContent = (labelOutOfBtn != null) ? <div className='label-outof-btn text-truncate'>{this.getNlsLabel(labelOutOfBtn, intl)}</div> : null
    const labelInBtnContent = (labelInBtn != null) ? <div className='label-in-btn'>{this.getNlsLabel(labelInBtn, intl)}</div> : null
