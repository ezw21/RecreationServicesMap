...
const desktopIcon = require('jimu-ui/lib/icons/desktop-outlined-12.svg')
const padIcon = require('jimu-ui/lib/icons/pad-outlined-12.svg')
const mobileIcon = require('jimu-ui/lib/icons/mobile-outlined-12.svg')
  ...
  getBrowserIcons = (iconSize: number) => {
    ...
    return (
      <div className='d-flex justify-content-between align-items-center'>
        {isDesktop && <Icon size={iconSize} icon={desktopIcon} color={color} title={desktopLabel} />}
        {isPad && <Icon size={iconSize} icon={padIcon} color={color} className={isDesktop ? 'ml-1' : ''} title={padLabel} />}
        {isMobile && <Icon size={iconSize} icon={mobileIcon} color={color} className={isDesktop || isPad ? 'ml-1' : ''} title={mobileLabel} />}
      </div>
    )
  }
