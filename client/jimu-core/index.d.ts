...
import { ThemeProvider, jsx, css, Global, ThemeContext, withTheme } from '@emotion/react';
...
import type { PortalInfo } from './lib/session-manager';
...
import { keyCodes, keyMap } from './lib/keyboard/key-map';
...
declare const lodash: {
    ...
    throttle: <T_2 extends (...args: any) => any>(func: T_2, wait?: number, options?: import("lodash").ThrottleSettings) => import("lodash").DebouncedFunc<T_2>;
...
export { AppRoot, React, ReactDOM, ExtensionManager, BaseWidget, WidgetManager, ConfigManager, DataSourceManager, urlUtils, SessionManager, SessionChangedReasonType, appActions, extensionSpec, utils, appConfigUtils, themeUtils, ReactRedux, MessageManager, Immutable, classNames, uuidv1, queryString, moduleLoader, jimuHistory, ImmutableObject, ImmutableArray, portalUrlUtils, portalUtils, i18n, defaultMessages, DataSourceComponent, DataSourceComponentProps, MultipleDataSourceComponent, MultipleDataSourceComponentProps, IntlProvider, injectIntl, jsx, css, Global, ThemeContext, SerializedStyles, styled, xss, polished, MutableStoreManager, Keyboard, keyMap, keyCodes, AppKeyboardComponent, keyboardUtils, requestUtils, expressionUtils, dateUtils, createIntl, createIntlCache, useIntl, FormattedDate, FormattedMessage, FormattedNumber, FormattedPlural, FormattedRelativeTime, FormattedTime, IntlShape, esri, lodash, RepeatedDataSourceProvider, withRepeatedDataSource, RepeatedDataSource, dataSourceUtils, ExportJson, ExportCSV, ExportGeoJSON, DataActionManager, ThemeManager, invariant, CONSTANTS, ReactResizeDetector, ResizeObserver, ExpressionResolverComponent, ExpressionResolverErrorCode, MultipleExpressionResolveResults, SingleExpressionResolveResult, ServiceManager, version, privilegeUtils, spring, ThemeProvider, withTheme, saveAs, I18nMessages, PortalInfo };
