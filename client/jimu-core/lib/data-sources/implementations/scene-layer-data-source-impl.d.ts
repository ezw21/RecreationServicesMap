import { ServiceDefinition, IMDataSourceJson, IMDataSourceSchema, IMReversedDataSourceSchema } from 'jimu-core';
...
import { DataSourceConstructorOptions, DataSourceTypes, SceneLayerDataSource, IMFeatureLayerQueryParams, QueryResult, FeatureDataRecord, FeatureLayerQueryParams, CodedValue, WidgetDataSourcePair, QueryOptions, DataRecord, QueryParams } from '../data-source-interface';
