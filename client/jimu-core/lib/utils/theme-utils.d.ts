 ...
 */
declare function getThemeNameFromUri(themeUri?: string): string;
/**
 ...
 */
declare function valueOf(path: string, variables?: Partial<ThemeVariables>): string;
/**
 ...
 * if undefined, the theme variables from the current app will be used.
 */
declare function color(path: string, variables?: Partial<ThemeVariables>): string;
/**
...
declare function getThemeVariablesByCategory(categoryName: ComponentCategoryType, useBuilderTheme: boolean): Array<{
    component: string;
    styles: Immutable.ImmutableObject<any>;
}>;
