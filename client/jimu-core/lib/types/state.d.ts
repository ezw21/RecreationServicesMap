...
export interface RuntimeInfo {
    /** Whether a widget class is loaded */
...
export interface AppContext {
    ...
    /** Whether access from a touch device  */
...
export interface JimuMapViewInfo {
    /** id */
    id: string;
    /** The map widget id that creates the map view */
    mapWidgetId: string;
    /** Whether the map view is active */
    isActive?: boolean;
    /** The related data source id */
    dataSourceId: string;
    /** The map view status */
