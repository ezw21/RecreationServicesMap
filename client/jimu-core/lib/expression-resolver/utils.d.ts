...
export declare function resolveFieldAndFunctionParts(partsGroupByFunction: ExpressionPartGoup[], useDataSources: ImmutableArray<UseDataSource>, repeatedDataSource: RepeatedDataSource | RepeatedDataSource[], whetherFormatData: boolean, intl?: IntlShape): Array<Promise<ExpressionPart>>;
