...
export interface DropAreaProps {
    ...
    onDragOver?: (draggingItem: LayoutItemConstructorProps, draggingElement: HTMLElement, containerRect: ClientRect, itemRect: ClientRect, clientX: number, clientY: number, speed?: number) => void;
...
export declare function restrictItemInContainer(itemRect: Partial<ClientRect>, containerRect: Partial<ClientRect>): Partial<ClientRect>;
