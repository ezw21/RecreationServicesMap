...
declare const _default: ReactRedux.ConnectedComponent<typeof LayoutItemAnimationSetting, ReactRedux.Omit<React.ClassAttributes<LayoutItemAnimationSetting> & OwnProps & StateProps, "setting" | "sectionId" | "transitionType" | "isSection" | "isWidget" | "isLayoutWidget" | "transitionDirection"> & OwnProps>;
