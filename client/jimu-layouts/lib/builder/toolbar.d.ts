...
export declare const Toolbar: ReactRedux.ConnectedComponent<typeof _Toolbar, ReactRedux.Omit<React.ClassAttributes<_Toolbar> & ToolbarProps & StateToProps, "isLockLayout"> & ToolbarProps>;
export {};
