...
declare const _default: ReactRedux.ConnectedComponent<typeof LayoutEntry, ReactRedux.Omit<React.ClassAttributes<LayoutEntry> & LayoutProps & StateToLayoutProps, "browserSizeMode" | "mainSizeMode" | "layout"> & LayoutProps>;
