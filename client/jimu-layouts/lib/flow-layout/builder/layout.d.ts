...
declare const _default: ReactRedux.ConnectedComponent<typeof Layout, ReactRedux.Omit<React.ClassAttributes<Layout> & LayoutProps & StateToLayoutProps, "browserSizeMode" | "mainSizeMode" | "layout"> & LayoutProps>;
