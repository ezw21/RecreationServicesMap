...
export declare const WidgetRenderer: ReactRedux.ConnectedComponent<typeof _WidgetRenderer, ReactRedux.Omit<React.ClassAttributes<_WidgetRenderer> & LayoutItemProps & WidgetProps, "rotate" | "widgetJson" | "widgetId" | "isClassLoaded" | "isInlineEditing" | "supportInlineEditing" | "supportRepeat" | "hasEmbeddedLayout" | "canCrossLayoutBoundary" | "isFunctionalWidget" | "widgetState" | "widgetStyle" | "hasExtension"> & LayoutItemProps>;
export {};
