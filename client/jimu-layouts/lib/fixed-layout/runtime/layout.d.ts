...
declare const _default: ReactRedux.ConnectedComponent<typeof FixedLayoutViewer, ReactRedux.Omit<React.ClassAttributes<FixedLayoutViewer> & LayoutProps & StateToLayoutProps, "browserSizeMode" | "mainSizeMode" | "layout"> & LayoutProps>;
