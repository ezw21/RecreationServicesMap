...
export declare const GridContainer: ReactRedux.ConnectedComponent<typeof ContainerClass, ReactRedux.Omit<React.ClassAttributes<ContainerClass> & ContainerProps & StateToContainerProps, "layoutItem" | "subContainerIds"> & ContainerProps>;
export {};
